...
function AddShiftForm() {
  ...
  useEffect(() => {
    ...
    //listens to changes in the user's authentication status, if the user is logged in it is set to the status, if not the user is redirected to the login page    
